        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <div className="max-w-lg">
              ...
              <button className="bg-primary text-white px-8 py-4 text-sm font-medium tracking-[2px] uppercase hover:bg-coral transition-colors duration-300 rounded-full">
                Explore Collection
              </button>
            </div>
          </div>
